                    ...
                    <div class="sb-sidenav-menu ">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseSR" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link text-light loading" href="../../employee/fieldworker/awardee.php">View Your Rating</a>
                                </nav>
                            </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body bg-dark">
                                        <div class="row">
                                            ...
                                            <div class="card-body bg-dark">
                                                <form id="infoForm" action="../../employee_db/fieldworker/update_profile.php" method="post">
                                                    <div class="row mb-3">
                                                        <div class="col-sm-4 bg-dark form-floating mb-3">
                                        ...
                                        <form action="../../employee_db/fieldworker/update_employee_pfp.php" method="post" enctype="multipart/form-data" id="profilePictureForm" style="display:none;">
                    ...
                    <div class="modal fade" id="deleteProfilePictureModal" tabindex="-1" aria-labelledby="deleteProfilePictureLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content bg-dark text-light">
                                ...
                                <div class="modal-footer border-top border-secondary">
                                    <form action="../../employee_db/fieldworker/delete_employee_pfp.php" method="post">
