...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reaction'])) {
    ...
    $sql = "INSERT INTO reactions (employee_id, awardee_id, reaction_type) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseTAD" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link text-light loading" href="../../employee/staff/attendance.php">Attendance</a>
                            </nav>
                        </div>
...
<script>
    ...
    let calendar;
        ...
        function selectReaction(reaction, awardeeId) {
            fetch('/HR2/employee/staff/awardee.php', {
                method: 'POST',
                headers: {
