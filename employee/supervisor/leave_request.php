                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content bg-dark text-light">
                                                        ...
                                                        <div class="modal-footer border-top border-secondary">
                                                            ...
                                                            <button type="button" class="btn btn-success" onclick="window.location.href='leave_request.php?leave_id=<?php echo $row['leave_id']; ?>&status=approve'">Approve</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal fade" id="confirmDenyModal<?php echo $row['leave_id']; ?>" tabindex="-1" aria-labelledby="confirmDenyModalLabel<?php echo $row['leave_id']; ?>" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content bg-dark text-light">
                                                        ...
                                                        <div class="modal-footer border-top border-secondary">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                            <button type="button" class="btn btn-danger" onclick="window.location.href='leave_request.php?leave_id=<?php echo $row['leave_id']; ?>&status=deny'">Deny</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
