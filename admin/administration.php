...
<body class="bg-dark text-light">
    ...
    <script>
        ...
        function submitEvaluation() {
            ...
            const department = 'Administration Department';
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response === 'You have already evaluated this employee.') {
                        ...
                        showSuccessModal('Evaluation submitted successfully!');
                    }
                },
                error: function (err) {
                    console.error(err);
                    showErrorModal('An error occurred while submitting the evaluation.');
                }
            });
        }
        ...
        // Add event listeners to close the success modal
