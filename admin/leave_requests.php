                                        ...
                                        <td>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center mb-0">
                                                    <button class="btn btn-success btn-sm me-2" data-bs-toggle="modal" data-bs-target="#confirmApproveModal<?php echo $row['leave_id']; ?>">Approve</button>
                                                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmDenyModal<?php echo $row['leave_id']; ?>">Deny</button>
                                                </div>
                                            </td>
                                            <!-- Confirm Approve Modal -->
                                            <div class="modal fade" id="confirmApproveModal<?php echo $row['leave_id']; ?>" tabindex="-1" aria-labelledby="confirmApproveModalLabel<?php echo $row['leave_id']; ?>" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content bg-dark text-light">
                                                        <div class="modal-header border-bottom border-secondary">
                                                            <h5 class="modal-title" id="confirmApproveModalLabel<?php echo $row['leave_id']; ?>">Approve Leave Request</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        ...
                                                        <div class="modal-footer border-top border-secondary">
                                                            ...
                                                            <button type="button" class="btn btn-success" onclick="approveLeaveRequest(<?php echo $row['leave_id']; ?>)">Approve</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Confirm Deny Modal -->
                                            <div class="modal fade" id="confirmDenyModal<?php echo $row['leave_id']; ?>" tabindex="-1" aria-labelledby="confirmDenyModalLabel<?php echo $row['leave_id']; ?>" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content bg-dark text-light">
                                                        <div class="modal-header border-bottom border-secondary">
                                                            <h5 class="modal-title" id="confirmDenyModalLabel<?php echo $row['leave_id']; ?>">Deny Leave Request</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                        ...
                                                        <div class="modal-footer border-top border-secondary">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                            <button type="button" class="btn btn-danger" onclick="window.location.href='leave_requests.php?leave_id=<?php echo $row['leave_id']; ?>&status=deny'">Deny</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    function approveLeaveRequest(leaveId) {
        <?php $_SESSION['status_message'] = 'Leave request approved successfully.'; ?>
        var statusModal = new bootstrap.Modal(document.getElementById('statusModal'));
        statusModal.show();
        statusModal._element.addEventListener('hidden.bs.modal', function () {
            window.location.href = `leave_requests.php?leave_id=${leaveId}&status=approve`;
        });
    }
</script>
